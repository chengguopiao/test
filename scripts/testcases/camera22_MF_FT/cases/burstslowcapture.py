...
class BurstCameraTest(unittest.TestCase):
    ...
    def testCapturePictureWithScenesNightPortrait(self):
        """
        Summary:testCapturePictureWithScenes NightPortrait: Capture image with Scene mode NightPortrait
        Steps:  1.Launch burst activity and select Slow burst mode
